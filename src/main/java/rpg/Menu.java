 ...
 */
// j'ai cr�er 3 m�thodes a la toute fin de la classe et aie modifi� l�g�rement l'affichage pour faire apparaitre les boutons save load qui utilisent mes m�thodes.
public class Menu extends FXGLMenu {
    ...
    protected MenuBox createMenuBodyGameMenu() {
        ...
        MenuButton itemLoad = new MenuButton("menu.load");
        itemLoad.setOnAction(e -> loadFromGameMenu());
        box.add(itemLoad);
