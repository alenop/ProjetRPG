...
import rpg.data.character.SaveLoad;
import rpg.data.elementInteractifs.Arme;
import rpg.data.elementInteractifs.Armure;
...
import rpg.data.elementInteractifs.ManaPotion;
import rpg.data.elementInteractifs.PNJ;
import rpg.data.elementInteractifs.HealPotion;
import rpg.data.map.ModeleMap;
import rpg.factory.MenuSceneFactory;
...
public class RPGApp extends GameApplication {
	...
	protected void initGame() {
		...
		getAudioPlayer().setGlobalMusicVolume(0.05);
		getAudioPlayer().setGlobalSoundVolume(0.05);
		...
		liste[0]="Une arme adapt�e ?";
		liste[1]="Oui papa";
		HashMap<String,String[]> conversation = Chat(liste,"Un rat mange tout mon fromage dans la cave ! va t'equiper d'une arme adapt�e et tue le !");
		String[] liste2=new String[2];
		liste2[0]="Oui papa";
		liste2[1]="prot�in� ?";
		HashMap<String,String[]> conversation2 = Chat(liste2,"Seule une arme adapt�e te permettra de vaincre ce rat mangeur de fromage prot�in�");
		String[] liste3=new String[1];
		liste3[0]="Oui papa";
		HashMap<String,String[]> conversation3 = Chat(liste3,"Va me tuer ce rat et arr�te de poser tant de questions !");
		String[] liste4=new String[1];
		liste4[0]="Merci papa";
		HashMap<String,String[]> conversation4 = Chat(liste4,"Bravo fils!");
		String[] liste5=new String[1];
		liste5[0]="oui papa";
		HashMap<String,String[]> conversation5 = Chat(liste5,"Eh bien ce rat te pose des soucis ? n'oublie\n pas seule une arme adapt�e te permettra\n de vaincre ce rat");
		...
		conversationComplete.put("Une arme adapt�e ?", conversation2);
		conversationComplete.put("prot�in� ?", conversation3);
		...
		HashMap<String, String[]> conversation1A = Chat(answer1A, "Oh bonjour mon ptit "+hero.getName()+" ! \nTu veux que je te raconte la fois ou j'ai �chouer \n� vaincre un criminel de mon �p�e ? \nQuel rat celui la !");
		HashMap<String, String[]> conversation1B1 = Chat(answer1B, "Je crois que je m'en souviens plus..");
		HashMap<String, String[]> conversation1B2 = Chat(answer1B, "Ah...Je m'en souviens plus de toute fa�on..");
		...
		HashMap<String, String[]> conversation2B2 = Chat(answer2B, "Tu es s�r ? Penses y si tu dois t'�quiper");
		...
		conversationComplete1.put("Bof �a ira, merci...", conversation1B2);
	...
	public void createChest(String map, Point2D pos, rpg.data.elementInteractifs.Chest chest) {
	...
	public static void createIndice(String map, Point2D pos, rpg.data.elementInteractifs.Indice indice) {
