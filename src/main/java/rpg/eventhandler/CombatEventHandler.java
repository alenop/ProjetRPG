...
import rpg.data.character.Attack;
import rpg.data.character.Boost;
import rpg.data.character.Heal;
import rpg.data.character.Monstre;
import rpg.data.character.SkillType;
...
public class CombatEventHandler extends DisplayBasic implements EventHandler<ActionEvent> {
	...
	public void handle(ActionEvent arg0) {
		...
		if (choix.equals("d�fense") || choix.equals("attaque") || choix.equals("skills")) {
			...
			if ((choix.equals("d�fense")|| (choix.equals("skills") && RPGApp.hero.getSkills().get(nbSkill).getType()!=SkillType.attaque )) && RPGApp.hero.getState() == State.alive) {
